          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <p className="text-sm text-slate-600 mb-4">
                These are default email settings for all material lines in this
                organization. Individual material lines can override these
                settings.
              </p>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500">
                    Default name shown as the sender in quote confirmation
                    emails. If not set, defaults to &quot;Countertop
                    Visualizer&quot;.
                  </p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className="mt-1 text-sm text-slate-500">
                    Default email address where replies to quote confirmation
                    emails will be sent
                  </p>
                </div>
              </div>
