...
export default function WhitelabelHome() {
  ...
  useEffect(() => {
    const loadSlabs = async () => {
      ...
      if (!materialLine || materialLine.organizationId === "default") {
  ...
  const isExample = !materialLine || materialLine.organizationId === "default";
  ...
  const generateSingleImage = useCallback(
    async (
      ...
      try {
        ...
        // canvas/memory crashes on large or non-JPEG slab assets.
